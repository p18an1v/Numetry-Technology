...
public class VAttend1 extends JFrame implements ActionListener{
	...
	VAttend1(){
		...
		try {
			File f1=new File("C:\\Users\\vishw\\OneDrive\\Documents\\Desktop\\Numetry\\Attendance-Management-System-master\\.txt\\StudLin.txt");
			Scanner rd=new Scanner(f1);
			user=rd.next();
			rd.close();
			
			File f2=new File("C:\\Users\\vishw\\OneDrive\\Documents\\Desktop\\Numetry\\Attendance-Management-System-master\\.txt\\Attend2.txt");
